    ...
    <div className="flex flex-col place-items-center w-1k h- mt-20">
      <div className="text- flex flex-col justify-start place-items-start w-full py-12">
        ...
        <div className="text-2xl py-20 leading-relaxed tracking-wider text-justify">
          ...
          <br />
          <br />
          This Agreement contains all of the terms and conditions applicable to
          you while participating at the facility. If you do not agree to be
          bound by the terms and conditions of this User Agreement, please do
          not enroll in the AB Badminton. You must read, accept and sign all the
          terms and conditions contained in this User Agreement, which include
          ...
          <br />
          <br />
          2. Members are permitted to bring guests (up to 2 guests per visit) to
          AB Badminton with the condition that the guests also accept the
          conditions listed herein, and members will the full responsibility and
          liability for their guests. Please refer to Waiver and Release of
          Liability for detail.
          <br />
          <br />
          ...
          the game. For”drop-in”badminton, all participants are also expected to
          exercise fair play while sharing court with others.
          <br />
          <br />
          5. All members and guests attending the AB Badminton must change into
          appropriate sporting attires and athletic footwear before entering the
          game.
          <br />
          <br />
          ...
          <br />
          <br />
          7. AB Badminton should not be held responsible for any lost or stolen
          items in our facilities.
          <br />
          <br />
