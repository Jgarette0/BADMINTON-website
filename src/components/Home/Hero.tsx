          ...
          <div className="flex flex-wrap -m-4">
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <Card className="p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-base">
                  Fundamental skills such as grip, footwork, and strokes to
                  provide a strong foundation for players.
                </p>
              </Card>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <Card className="p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-base">
                  Focuses on mastering advanced shots like drops, smashes, and
                  drives, enhancing players' offensive and defensive
                  capabilities.
                </p>
              </Card>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <Card className="p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-base">
                  Teaches players how to analyze opponents, adapt gameplay, and
                  use strategic tactics to gain a competitive edge.
                </p>
              </Card>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <Card className="p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-base">
                  Aims to improve players' overall fitness, agility, and stamina
                  through specific badminton-focused exercises and drills.
                </p>
              </Card>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <Card className="p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-base">
                  Helps players develop mental resilience, concentration, and
                  focus, crucial for maintaining composure during matches.
                </p>
              </Card>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
