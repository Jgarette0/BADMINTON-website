  ...
  return (
    <>
      <div className="w-screen h-screen bg-[#007dfe] flex flex-col place-items-center justify-center gap-8 rounded-md absolute">
        <img src="img/gcash.png" className="scale-75 md:scale-100" alt="" />
        <div className="flex flex-col-reverse md:flex-row gap-12 p-8">
          <Link to="/">
            <button className="p-8 md:w-64 w-80 place-items-center justify-center text-center md:scale-100 scale-90 h-24 text-[#007dfe] hover:opacity-80 text-lg font-mona font-semibold bg-white rounded-full">
              Go back
            </button>
          </Link>
          <a
